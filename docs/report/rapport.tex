...
\begin{figure}[!ht]
    \begin{center}
        \includegraphics[width = 0.6\linewidth]{img/planete.png}
...
\footnotetext{\href{https://www.redblobgames.com/x/1842-delaunay-voronoi-sphere/}{https://www.redblobgames.com, Delaunay + Voronoi on a sphere
Posted on March 10, 2019 by RedBlobGames\\Last access : 05/04/2020.}}
...
Posted on May 13, 2015 by Cyber Shaman\\Last access : 05/04/2020.}}
    ...
    Un exemple très simple de bruit serait celui dit "blanc"(figure \ref{whitenoise}), ne faisant pas partie de ces bruits chaotiques, il est purement aléatoire et se retrouve dans de nombreux domaines. Il est peu intéressant pour générer des environnements réalistes, et c'est pour cela que l'on écartera tous les bruits que l'on ne peut pas contrôler.\\
        ...
        \footnotetext{\href{https://upload.wikimedia.org/wikipedia/commons/thumb/f/f6/White-noise-mv255-240x180.png/220px-White-noise-mv255-240x180.png}{Image from wikipedia\\Last access : 05/04/2020.}}
    ...
    \begin{figure}[!ht]
    \begin{center}
    \includegraphics[width=0.3\linewidth]{img/noise/value.png}
    \includegraphics[width=0.3\linewidth]{img/noise/perlin.png}
    \end{center}
    \begin{center}
    \includegraphics[width=0.3\linewidth]{img/noise/simplex.png}
     \includegraphics[width=0.3\linewidth]{img/noise/voronoi.png}
     \end{center}
     \begin{center}
    \includegraphics[width=0.3\linewidth]{img/noise/worley.png}
    \end{center}
...
\subsubsection{Bibliothèques de bruit}
    ...
    \footnotetext{Selon les chiffres donnée par la page : \href{https://jordanpeck.me/2016/05/fastnoise/}{https://jordanpeck.me/2016/05/fastnoise/\\Last access : 05/04/2020.}}
...
\begin{figure}[!ht]
\centering
 \makebox[\textwidth][c]{\includegraphics[width = 1.2\textwidth]{img/seqmodel.png}}
...
\footnotetext{\href{https://en.wikipedia.org/wiki/Blinn%E2%80%93Phong_reflection_model
}{https://en.wikipedia.org/wiki/Blinn–Phong\_reflection\_model, Accessed 4 April 2020}}
...
\footnotetext{\href{https://openclassrooms.com/fr/courses/966823-developpez-vos-applications-3d-avec-opengl-3-3/961139-introduction-aux-shaders}{https://openclassrooms.com/fr/courses/966823-developpez-vos-applications-3d-avec-opengl-3-3/961139-introduction-aux-shaders, Accessed 3 March 2020}
}
